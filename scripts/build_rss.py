...
def build_rss(index_path: str, output_path: str, repo_link: str) -> None:
    ...
    ET.SubElement(channel, "description").text = "Daily arXiv astronomy reports for Zotero."
    ...
    for report in reports:
        ...
        ET.SubElement(item, "guid").text = report.get("guid", report.get("report_url", repo_link))
        if report.get("created_at"):
            ET.SubElement(item, "pubDate").text = _to_rfc2822(report["created_at"])
